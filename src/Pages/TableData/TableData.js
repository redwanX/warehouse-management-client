...
const TableData = (props) => {
  ...
  return (
    ...
    <td className='fw-normal text-center' data-lebel="ID">{_id}</td>
    <td className='fw-normal text-center' data-lebel="Image"><img src={image} style={{width:"75px"}} alt="" /></td>
    <td className='fw-normal text-center' data-lebel="Name">{name}</td>
    ...
    <td><button className='btn btn-dark rounded-pill '>Delete</button></td>
  </tr>
  )
}
